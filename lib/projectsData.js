export const projectsData = [
  ...
  },
  {
    ...
    imageNeedsBackground: true,
    detailedDescription: {
      es: "Aplicacion web que fue implementada en negocios que buscaban llevar el control de stock y ventas. Guarda todas las ventas en cajas por día y permite ver el detalle tanto de la caja como de las ventas. Cada negocio tiene sus propias credenciales por las cuales puede acceder al sistema y manejar su stock, productos y ventas. El proyecto fue desarrollado con Next.js.",
      en: "Web application that was implemented in businesses looking to keep track of stock and sales. It saves all sales in cash registers by day and allows you to see the details of both the cash register and the sales. Each business has its own credentials through which they can access the system and manage their stock, products, and sales. The project was developed with Next.js."
    },
    galleryImages: [
      {
